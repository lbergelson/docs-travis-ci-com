...
##### This merge mode currently only affects key-value maps, not lists. Lists will be replaced instead of merged.
##### Additional merge modes which work with lists are available as part of the [enhanced build config validation beta](https://docs.travis-ci.com/user/build-config-validation).
